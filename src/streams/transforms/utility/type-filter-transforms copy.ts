...
export function typeFilterTransform<TSource, TDestination extends TSource>(typeFilterFunction: (chunk: TSource) => chunk is TDestination, options?: FullTransformOptions<TSource>) {
