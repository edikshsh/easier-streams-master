...
export function callOnDataSyncTransform<TSource>(functionToCallOnData: (data: TSource) => void,
...
export function callOnDataAsyncTransform<TSource>(functionToCallOnData: (data: TSource) => Promise<void>,
    options?: FullTransformOptions<TSource>) {
