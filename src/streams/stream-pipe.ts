...
class StreamPipe<Tsource, Tdestination> extends TypedEventEmitter<StreamPipeEvents<Tdestination>> {
    constructor(
        private _source: TypedTransform<Tsource, unknown>,
    ...
    pipe<T extends StreamPipe<unknown, unknown>>(
        destination: T,
...
export function getStreamPipe<T1, T2, T3, T4, T5>(
    ...transforms: TypedTransformPipe_05<T1, T2, T3, T4, T5>
): StreamPipe<T1, T5>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6>(
    ...transforms: TypedTransformPipe_06<T1, T2, T3, T4, T5, T6>
): StreamPipe<T1, T6>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7>(
    ...transforms: TypedTransformPipe_07<T1, T2, T3, T4, T5, T6, T7>
): StreamPipe<T1, T7>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7, T8>(
    ...transforms: TypedTransformPipe_08<T1, T2, T3, T4, T5, T6, T7, T8>
): StreamPipe<T1, T8>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...transforms: TypedTransformPipe_09<T1, T2, T3, T4, T5, T6, T7, T8, T9>
): StreamPipe<T1, T9>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
    ...transforms: TypedTransformPipe_10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
): StreamPipe<T1, T10>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
    ...transforms: TypedTransformPipe_11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
): StreamPipe<T1, T11>;
export function getStreamPipe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
    ...transforms: TypedTransformPipe_12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
): StreamPipe<T1, T12>;
